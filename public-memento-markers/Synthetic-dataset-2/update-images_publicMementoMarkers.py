...
# Load dataset file
with open("public-memento-markers/Synthetic-dataset-2/public-memento-markers_without-media.json", "r", encoding="utf-8") as f:
    dataset = json.load(f)
...
output_path = "public-memento-markers/Synthetic-dataset-2/public-memento-markers.json"
